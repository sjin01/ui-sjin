define(['jquery',"css!../css/component/tooltip.css"],function($){
    ...
    Tooltip.prototype.show = function () {
        ...
        if (this.hasContent()) {
            ...
            $tip
                ...
                .addClass(this.classPrefix+placement)
                .data(this.type, this);
            ...
            if (autoPlace) {
                ...
                $tip
                    .removeClass(this.classPrefix+orgPlacement)
                    .addClass(this.classPrefix+placement);
            }
    ...
    Tooltip.prototype.setContent = function () {
        ...
        $.each(["top","bottom","left","right"],function(index,position){
