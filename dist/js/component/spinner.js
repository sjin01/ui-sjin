define(['jquery',"css!../css/component/spinner.css"], function ($) {
        ...
        return this.each(function () {
            ...
            if(!$(this).data("spinner")){
                ...
                textField.wrap(container);
                 increaseButton = $('<button type="button" onClick="changeValueAdd(this)">+</button>').click(
                //increaseButton = $('<button type="button" >+</button>').click(
                        function () {
                            changeValue(true);
                        });
                 decreaseButton = $('<button type="button" onClick="changeValueReduce(this)">-</button>').click(
                //decreaseButton = $('<button type="button" >-</button>').click(
                        function () {
                        changeValue(false);
                 });
                var borderHeight = 2;
